...
hd.write('      <p><b>适配度 ＝ 命中条数 / 要求总条数</b>，清单取 JD 自己写的那一段，'
         ...
         '写成一条带原文的具名扣分单独列出来。</p>\n')
hd.write('      <p><b>公司发展 ＝ 四问各 25 分</b>，全部确定性判、不用模型：'
         '①<b>碰的是 AI 产品本身</b>吗（JD 里 AI / LLM / agent 词的密度）'
         '②<b>雇主是甲方</b>吗（JD 有没有 our client / staffing / recruitment agency 这类代招字眼）'
         '③<b>公司在长</b>吗（LinkedIn 公司页：两年员工增速 / 中位任期，读不到就按成立年份 × 规模粗判）'
         '④<b>三年后还值钱</b>吗（融资轮次 / Glassdoor——目前没有可核的公开来源，<b>一律未核</b>）。'
         '未核的那问不进分母，核出几问就按几问折成百分制。<b>两项缺任何一项，这个岗就没有优先级。</b></p>\n')
hd.write('    </details>\n')
hd.write('  </div>\n')
